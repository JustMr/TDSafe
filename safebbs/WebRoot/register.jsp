  		...
  		<div id="reg_mid">
  			<div id="reg_box">
  				...
  				<form action="">
  					...
  					<div id="regmail" class="regstyle">
  						<div id="Verification">
  							<input id="regcheck0" name="regcheck0" class="regcheck" type="text" placeholder="验证码">
  							<div>
  								<span></span>
  							</div>
  						</div>
  					...
  					<div id="regphone" class="regstyle">
  						<div id="Verification1">
  							...
  							<input id="phonecheck" name="phonecheck" type="button" value="获取验证码">
  							<div>
  								<span></span>
  							</div>
  						</div>
  					</div>
					<div id="regname" class="register_box regstyle reghidden">
						<input id="name_input" class="reg_input" name="name_input" type="text" placeholder="用户名">
						<div>
							<span></span>
						</div>
					</div>
					<div id="repwd" class="register_box regstyle reghidden">
						<input id="pwd_input" class="reg_input" name="pwd_input" type="password" placeholder="密码" autocomplete="off">
						<div>
							<span></span>
						</div>
					</div>
					<div id="repwd1" class="register_box regstyle reghidden">
  					...
  					<div id="reglawread" class="register_box">
  						...
  						<a href="bbslaw.jsp">《TDSafe服务条款》</a>
  					</div>
  					<div id="regsurebut" class="register_box regstyle">
  						<input id="regbut" type="button" value="立即注册">
  					</div>
  					<div id="signin"><a href="login.jsp">已有账号，立即登录</a></div>
  				</form>
  			</div>
  		</div>
